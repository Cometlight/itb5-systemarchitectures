/**
 * In this controller, it is possible to achieve higher than recommended speeds on one wheel during turns.
 *
 */
public class ProportionalD extends BaseRobot {
	...
	protected void update() {
		...
		s[s.length-1] = 1d / getDistanceSensorDataSmoothed(Sensor.FRONT_L);	// inversely proportional to support sharp curve to the left in case of 180° turns
