...
public class AbandonBallBehaviour extends Behaviour {
	...
	private static final long ABANDONING_DURATION_TURN = 1000;	// [ms]
//	private static final long ABANDONING_DURATION_STABILIZE = 2000;	// [ms]	// TODO: it's actually 1000 ...
//	private static final long ABANDONING_COOLDOWN = 1000;	// [ms]
	private static final long NUMBER_OF_SAVED_MEDIAN_VALUES = 5;
	...
	public boolean update() {
		...
		double distanceValue = Arrays.stream(_baseRobot.getDistanceSensorDataSmoothed(Sensor.FRONT_L, Sensor.FRONT_R, Sensor.FRONT_LEFT, Sensor.FRONT_RIGHT)).sum() / 4d;
...
//			
		} else if (distanceValue > 1500d && ( Math.abs(oldestMedianX - x) < 0.005 || Math.abs(oldestMedianY - y) < 0.005 ) ) {
